...
//// overload indexVBO to include tangents and bitangents
//void indexVBO(
//    const std::vector<glm::vec3>& in_vertices,
//    const std::vector<glm::vec2>& in_uvs,
//    const std::vector<glm::vec3>& in_normals,
...
public:
    std::vector<glm::vec3> vertices, normals, tangents, bitangents, indexedVertices, indexedNormals, indexedTangents, indexedBitangents; // include tangents and bitangents
    std::vector<glm::vec2> uvs, indexedUVS;
    std::vector<unsigned int> indices;

    GLuint VAO, verticesVBO, uvsVBO, normalsVBO, elementVBO;
    GLuint tangentsVBO, bitangentsVBO; // include tangents and bitangents
